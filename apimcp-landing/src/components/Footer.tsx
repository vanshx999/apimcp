          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10 md:gap-8">
            <div className="md:col-span-2">
              ...
              <p className="text-xs text-text-muted/60 leading-relaxed max-w-sm font-sans">
                Open-source tool that turns any OpenAPI spec into a live MCP server on Cloudflare Workers.
              </p>
            ...
            <div>
              ...
              <div className="space-y-2.5">
                {['01 Paste', '02 Generate', '03 Deploy'].map((s, i) => (
            ...
            <div className="flex flex-col items-start md:items-end justify-between">
              <div className="border-2 border-border-light px-5 py-4 transition-all duration-300 hover:border-stamp/30 hover:shadow-[0_0_15px_rgba(255,107,53,0.1)]"
                ...
                <div className="text-[8px] font-mono text-stamp/60 uppercase tracking-[0.25em]">Approved for</div>
                <div className="font-mono text-sm font-bold text-text leading-tight mt-0.5">AGENT USE</div>
                <div className="text-[9px] font-mono text-text-dim/40 mt-1.5">MCP Protocol 2025-11-25</div>
